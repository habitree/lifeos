...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantStyles = {
      primary:
        'bg-primary-500 text-white hover:bg-primary-600 active:bg-primary-700 disabled:bg-gray-300 disabled:text-gray-500',
      secondary:
        'bg-gray-100 text-gray-700 hover:bg-gray-200 active:bg-gray-300 disabled:bg-gray-100 disabled:text-gray-400',
      reset:
        'bg-reset-default text-white hover:bg-reset-hover active:bg-orange-700 disabled:bg-gray-300 disabled:text-gray-500',
    };
    ...
    const focusRingStyles = {
      ...
      reset: 'focus:ring-reset-default',
    };
